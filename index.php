...
#unknown h2.frame-5 span{-webkit-animation:blurFadeIn 3s ease-in 0s backwards;-moz-animation:blurFadeIn 1s ease-in 0s backwards;-ms-animation:blurFadeIn 3s ease-in 0s backwards;animation:blurFadeIn 3s ease-in 0s backwards;color:transparent;text-shadow:0px 0px 1px #fff}
#unknown h2.frame-5 span:nth-child(2){-webkit-animation-delay:1s;-moz-animation-delay:1s;-ms-animation-delay:1s;animation-delay:1s}
#unknown h2.frame-5 span:nth-child(3){-webkit-animation-delay:2s;-moz-animation-delay:2s;-ms-animation-delay:2s;animation-delay:2s}
#unknown h2.frame-5 span:nth-child(4){-webkit-animation-delay:3s;-moz-animation-delay:3s;-ms-animation-delay:3s;animation-delay:3s}
#unknown h2.frame-5 span:nth-child(5){-webkit-animation-delay:4s;-moz-animation-delay:4s;-ms-animation-delay:4s;animation-delay:4s}
...
#unknown h2.frame-6 span:nth-child(2){-webkit-animation-delay:4s;-moz-animation-delay:4s;-ms-animation-delay:4s;animation-delay:4s;font-size:20px;color:#FFF;}
#unknown h2.frame-6 span:nth-child(3){-webkit-animation-delay:4s;-moz-animation-delay:4s;-ms-animation-delay:4s;animation-delay:4s;}
#unknown h2.frame-6 span:nth-child(4){-webkit-animation-delay:4s;-moz-animation-delay:4s;-ms-animation-delay:4s;animation-delay:4s;}
#unknown h2.frame-6 span:nth-child(5){-webkit-animation-delay:4s;-moz-animation-delay:4s;-ms-animation-delay:4s;animation-delay:4s;font-size:20px;color:#FFF;}
